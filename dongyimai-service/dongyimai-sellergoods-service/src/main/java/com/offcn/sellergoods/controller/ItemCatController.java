...
public class ItemCatController {
    ...
    @ApiOperation(value = "ItemCat根据父ID查询",notes = "根据父ID查询ItemCat方法详情",tags = {"ItemCatController"})
    @ApiImplicitParam(paramType = "path", name = "parentId", value = "父级ID", required = true, dataType = "Long")
    @GetMapping("/findByParentId/{parentId}")
    public Result<List<ItemCat>> findByParentId(@PathVariable Long parentId){
        //调用ItemCatService实现根据主键查询ItemCat
