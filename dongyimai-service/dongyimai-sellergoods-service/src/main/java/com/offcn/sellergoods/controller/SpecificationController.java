...
public class SpecificationController {
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "specEntity复合实体类",value = "传入JSON数据",required = false) SpecEntity specEntity,@PathVariable Long id){
        //设置主键值
    ...
    @PostMapping
    public Result add(@RequestBody  @ApiParam(name = "specEntity复合实体类",value = "传入JSON数据",required = true) SpecEntity specEntity){
