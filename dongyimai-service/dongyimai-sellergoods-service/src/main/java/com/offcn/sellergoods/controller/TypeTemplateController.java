...
public class TypeTemplateController {
     ...
     * @return
     */
    @ApiOperation(value = "根据模板id查询规格列表",notes = "根据模板id查询规格列表",tags = {"TypeTemplateController"})
    @GetMapping("/findSpecList/{typeId}")
    public  Result<List<Map>> findSpecList(Long typeId){
