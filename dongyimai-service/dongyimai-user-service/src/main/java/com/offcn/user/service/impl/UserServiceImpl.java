...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public void createSmsCode(String phoneNum) {
        String code =  (long)(Math.random()*1000000)+"";
        stringRedisTemplate.boundHashOps("smscode").put(phoneNum, code);
    ...
    public boolean checkSmsCode(String phoneNum, String code) {
        String smscode =(String) stringRedisTemplate.boundHashOps("smscode").get(phoneNum);
        if (smscode == null){
            return false;
        }
